...
<body>
    ...
    <section class="hero-section">
        <div class="container">
            <h1 class="display-6 mb-2 font-baru">Boring... Isn't there anything else more interesting to do?~~</h1>
            <img src="{{ asset('assets/images/Furina.png') }}" alt="Logo">
            <p class="lead mb-0 font-baru">The Queen's Crown still doesn't have a sequel yet? Pity, a classic like that where justice overcomes evil never gets old.</p>
        </div>
    </section>
